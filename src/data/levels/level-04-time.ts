...
export const level4Time: Level = {
  ...
  sentences: [
    ...
    },
    {
      ...
      parts: [
        { chinese: "晚上", pinyin: "wǎn shang", english: "evening / night", partOfSpeech: "time", distractors: getDistractors("time", "晚上", 3) },
        { chinese: "我", pinyin: "wǒ", english: "I / me", partOfSpeech: "subject", distractors: getDistractors("subject", "我", 3) },
    ...
    },
    {
      ...
      parts: [
        ...
        { chinese: "上班", pinyin: "shàng bān", english: "go to work", partOfSpeech: "object", distractors: ["学校", "家", "医院", "商店"] },
      ],
    },
    {
      id: "s4-l04",
